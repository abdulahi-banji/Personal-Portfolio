        ...
        <section style={styles.section}>
          ...
          <article style={styles.projectCard}>
            ...
            <p style={styles.projectText}>
              ...
              metadata records, improving query performance by 35%. [file:13]
            </p>
          </article>
          ...
          <article style={styles.projectCard}>
            ...
            <p style={styles.projectText}>
              ...
              highlight best practices for submitted code. [file:13]
            </p>
            <p style={styles.projectText}>
              Wrote 50+ test cases for diverse snippets and edge cases, boosting review efficiency by 40% and cutting
              common errors by 25%, with documentation that makes onboarding contributors effortless. [file:13]
            </p>
          </article>
        </section>
          ...
          <div style={styles.experienceGrid}>
            <article style={styles.experienceCard}>
              ...
              <p style={styles.experienceText}>
                ...
                coursework and technical skills. [file:13]
              </p>
              <p style={styles.experienceText}>
            ...
            <article style={styles.experienceCard}>
              ...
              <p style={styles.experienceText}>
                ...
                testing for safety‑critical reliability. [file:13]
              </p>
              <p style={styles.experienceText}>
            ...
            <article style={styles.experienceCard}>
              ...
              <p style={styles.experienceText}>
                ...
                performance bugs using better data structures. [file:13]
              </p>
            </article>
            ...
            <article style={styles.experienceCard}>
              ...
              <p style={styles.experienceText}>
                ...
                serving as their primary contact and support. [file:13]
              </p>
            </article>
          </div>
        </section>
